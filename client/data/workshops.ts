...
export const workshopsData: Workshop[] = [
  {
    ...
    shortDescription:
      "Master the principles of quantum computing and quantum algorithms",
    fullDescription:
      "Dive deep into the quantum realm and understand the fundamental principles that make quantum computing revolutionary. This comprehensive workshop covers qubits, quantum gates, superposition, entanglement, and practical quantum algorithms including Shor's algorithm and Grover's search.",
    date: "2025-01-20",
    time: "14:00 - 16:00",
    duration: "2 hours",
    capacity: 25,
    ...
    instructorBio:
      "Quantum Computing Researcher at MIT with 10+ years experience in quantum algorithms and quantum machine learning.",
    instructorImage:
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Excellent introduction to quantum computing. Dr. Chen explains complex concepts clearly.",
    ...
    challenges: [
      {
        ...
        language: "Python",
        problemStatement:
          "Implement quantum teleportation protocol using Qiskit",
        testCases: [],
      },
    ],
    isLive: true,
  ...
  },
  {
    ...
    fullDescription:
      "Comprehensive deep dive into neural network architectures, from basic perceptrons to advanced deep learning models. Learn to implement, train, and optimize neural networks for real-world applications.",
    date: "2025-01-25",
    time: "10:00 - 12:00",
    duration: "2 hours",
    capacity: 30,
    ...
    instructorBio:
      "AI Research Director with expertise in deep learning and neural architecture search.",
    instructorImage:
  ...
  },
  {
    ...
    fullDescription:
      "Learn to design and program autonomous robots for space exploration. Cover navigation in zero gravity, sensor fusion, and mission planning for Mars rovers and space station robots.",
    date: "2025-01-30",
    time: "13:00 - 15:00",
    duration: "2 hours",
    capacity: 20,
    ...
    instructorBio:
      "Former NASA engineer with 15 years experience in space robotics and autonomous systems.",
    instructorImage:
  ...
  },
  {
    ...
    fullDescription:
      "Deep dive into blockchain technology, consensus algorithms, and smart contract development. Build decentralized applications and understand cryptocurrency mechanics.",
    date: "2025-02-05",
    time: "16:00 - 18:00",
    duration: "2 hours",
    capacity: 35,
    ...
    instructorBio:
      "Blockchain architect with experience building enterprise blockchain solutions.",
    instructorImage:
  ...
  },
  {
    ...
    fullDescription:
      "Comprehensive course on ethical hacking methodologies, penetration testing, and vulnerability assessment. Learn to think like an attacker to better defend systems.",
    date: "2025-02-10",
    time: "09:00 - 11:00",
    duration: "2 hours",
    capacity: 15,
    ...
    instructorBio:
      "Cybersecurity expert with CISSP and CEH certifications, 12 years in information security.",
    instructorImage:
  ...
  },
  {
    ...
    fullDescription:
      "Comprehensive data science workshop covering statistical analysis, machine learning algorithms, and data visualization techniques using Python and R.",
    date: "2025-02-15",
    time: "11:00 - 13:00",
    duration: "2 hours",
    capacity: 40,
