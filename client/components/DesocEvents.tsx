...
const desocEvents: Event[] = [
  {
    ...
    description:
      "Annual flagship event featuring cutting-edge technology presentations, startup showcases, and networking opportunities.",
    longDescription:
      "GENESIS is DESOC's premier annual event that brings together the brightest minds in technology, innovation, and entrepreneurship. Experience groundbreaking presentations, participate in hands-on workshops, and connect with industry leaders who are shaping the future.",
    date: "2025-03-15",
    time: "09:00 AM",
    duration: "3 days",
    ...
    speakers: [
      {
        ...
        image:
          "https://images.unsplash.com/photo-1494790108755-2616b2e23e84?w=150&h=150&fit=crop&crop=face",
      },
      {
        name: "Marcus Chen",
    ...
    requirements: [
      "Student ID or Professional Badge",
    ...
    agenda: [
      ...
      {
        time: "10:00 AM",
        activity: "Opening Keynote: Future of Technology",
  ...
  },
  {
    ...
    description:
      "A dynamic event focused on personal development, skill building, and unleashing creative potential through interactive sessions.",
    longDescription:
      "Unleash is designed to help participants break barriers and unlock their full potential. Through intensive workshops, mentorship sessions, and collaborative projects, attendees will discover new skills and gain confidence to tackle any challenge.",
    date: "2025-02-20",
    time: "10:00 AM",
    duration: "2 days",
    ...
    agenda: [
      ...
      {
        time: "11:00 AM",
        activity: "Keynote: Unlocking Your Potential",
  ...
  },
  {
    ...
    description:
      "Technical symposium bringing together developers, engineers, and tech enthusiasts for deep-dive sessions and collaborative learning.",
    longDescription:
      "TechSabha is DESOC's premier technical gathering where code meets creativity. Dive deep into the latest technologies, participate in coding challenges, attend technical workshops, and collaborate with fellow developers on cutting-edge projects.",
    date: "2025-04-10",
    time: "08:30 AM",
    duration: "2 days",
    ...
    agenda: [
      ...
      {
        time: "09:30 AM",
        activity: "Opening: State of Modern Development",
        speaker: "David Kumar",
      },
      ...
      {
        time: "02:00 PM",
        activity: "Coding Challenge: Real-time Problem Solving",
      },
          ...
          <div className="relative mb-8">
            ...
            <div className="absolute bottom-8 left-8 text-white">
              <div className="flex items-center mb-4">
                <Badge
                  className={`bg-gradient-to-r ${eventColors[selectedEvent.type]} text-white mr-4`}
                >
                  {selectedEvent.name}
                </Badge>
                <Badge
                  className={`${getStatusColor(selectedEvent.status)} text-white capitalize`}
                >
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="flex items-center">
                        ...
                        <span>
                          ...
                          {selectedEvent.maxCapacity} registered
                        </span>
                      </div>
            ...
            <TabsContent value="agenda" className="space-y-6">
              <Card className="professional-card">
                <CardHeader>
                  ...
                  <CardDescription>
                    Detailed timeline of activities and sessions
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    {selectedEvent.agenda.map((item, index) => (
                      <div
                        key={index}
                        className="flex items-start p-4 bg-gradient-to-r from-white to-gray-50 rounded-lg border border-gray-200"
                      >
              ...
              <Card className="professional-card max-w-2xl mx-auto">
                ...
                <CardContent className="space-y-6">
                  ...
                  <p className="text-xs text-gray-500 text-center">
                    * Registration includes all sessions, materials, and
                    refreshments
                  </p>
                </CardContent>
              </Card>
    ...
    <div className="space-y-12">
      ...
      <div className="text-center">
        ...
        <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
          Join our signature events that bring together innovators, developers,
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {desocEvents.map((event) => {
          ...
          return (
            <Card
              key={event.id}
              className="professional-card group hover:shadow-2xl transition-all duration-500 transform hover:scale-105"
            >
              <div className="relative">
                ...
                <div className="absolute top-4 left-4">
                  <Badge
                    className={`bg-gradient-to-r ${eventColors[event.type]} text-white`}
                  >
                    {event.name}
                  </Badge>
                </div>
